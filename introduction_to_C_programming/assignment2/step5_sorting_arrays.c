...
//      print_roster(roster,number_of_employees);
      char *names[number_of_employees];
      for (int indx=0; indx<number_of_employees; indx++){
        names[indx]=roster[indx].name;
      }
      qsort(names,number_of_employees,sizeof(*names), str_compare);
      for (int indx=0; indx<number_of_employees; indx++){
        printf("%s\n",names[indx]);
      }
      ...
      char *cities[number_of_employees];
      for (int indx=0; indx<number_of_employees; indx++){
        cities[indx]=roster[indx].city;
      }
      qsort(cities,number_of_employees,sizeof(*cities), str_compare);
      for (int indx=0; indx<number_of_employees; indx++){
        printf("%s\n",cities[indx]);
      }
...
//      print_roster(roster,number_of_employees);
      double ary_of_pay[number_of_employees];
      for (int indx=0; indx<number_of_employees; indx++){
        ary_of_pay[indx]=roster[indx].annual_pay;
      }
      sort_doubles(ary_of_pay,number_of_employees);
      //qsort(ary_of_pay,number_of_employees, sizeof(double), double_compare);
      for (int indx=0; indx<number_of_employees; indx++){
        printf("%f\n",ary_of_pay[indx]);
      }
//      print_roster(roster,number_of_employees);
