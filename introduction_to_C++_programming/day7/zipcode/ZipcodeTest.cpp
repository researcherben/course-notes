...
int main()
{
    Zipcode myZips[SIZE]; // declaring array requires a no argument constructor
      
    // the comments above each is the record from the CSV; to be read later from file
